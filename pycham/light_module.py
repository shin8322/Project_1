...
class ExcelFluoPlotPanel(QtWidgets.QWidget):
    ...
    def _on_save_png(self):
        ...
        try:
            ...
            # exporter.parameters()['width'] = 1600  # 필요하면 해상도 고정
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        qp.addWidget(QtWidgets.QLabel("Ct"), 0, 7)
        ...
        self.lbl_ct: List[QtWidgets.QLabel] = []
        ...
        for i in range(4):
            ...
            ct = QtWidgets.QLabel("-")
            ct.setStyleSheet("font-weight:800; color:#dbe6ff;")
            self.lbl_ct.append(ct)
            qp.addWidget(ct, ch, 7)
        ...
        self.pnl_stream.setMaximumHeight(420)
    ...
    def _qpcr_build_plot_window(self):
        ...
        w = QtWidgets.QWidget()
        w.setWindowTitle("QPCR Amplification: ΔR + Threshold + Ct")
        w.resize(1250, 760)
    ...
    def _qpcr_recalc_one(self, ch: int):
        ...
        self.qpcr_ct[ch] = ct
        self.lbl_ct[ch - 1].setText("-" if ct is None else f"{ct:.2f}")
    ...
    def _save_excel(self):
        ...
        # ✅ 저장 후: Excel Plot 창을 띄우고, 방금 저장한 파일을 자동 로드
